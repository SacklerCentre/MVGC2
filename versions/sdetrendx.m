% SINUSOIDAL LEAST-SQUARES DETREND
%
% INVOCATION
%
% [y,s,p,q] = sdetrendx(x,fs,f)
%
% INPUTS
%
...
% OUTPUTS
%
% y         sinusoidally-detrended time-series
% s         the sinusoidal least-squares fits
...
function [y,s,p,q] = sdetrendx(x,fs,f)
...
assert(f > eps && f <= fs/2,'Frequency most lie in range (0 .. Nyqvist]');
...
s    = p.*comt+q.*somt;   % the sinusoidal trend on the (demeaned) x
