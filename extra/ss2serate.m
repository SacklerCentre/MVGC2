function erates = ss2serate(A,C,K,V,fs,fbands,fastfres)

% Calculate spectral entropy rates for SS model for specified frequency bands
%
% A, C, K, V are the ISS parameter matrices
%
% fs is sampling rate
%
