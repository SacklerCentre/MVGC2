...
for i = 1:nperms
	...
	FNULL(i)   = ss_to_mvgc(A,C,K,V,x,y);       % sample GC estimate from permutation null distribution
end
pval = mean(F <= FNULL); % p-value of F with respect to empirical permutation null distribution FNULL
